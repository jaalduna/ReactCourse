...
const useHero = (slugId: string) => {
  return useQuery({
    queryKey: ["heroes", { slugId }],
...
export default function SuperheroProfile({ heroSlugId }: Props) {
  const { data: superheroData, isError } = useHero(heroSlugId);
